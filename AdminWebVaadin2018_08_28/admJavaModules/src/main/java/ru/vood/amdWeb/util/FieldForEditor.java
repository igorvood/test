...
public class FieldForEditor<T> {
    ...
    private FieldPropertyEditor getFieldProperty(Field field) {
        ...
        if (viewColumnAnnotation instanceof ViewColumn) {
            ...
            final String displayName = viewColumn.displayName();
            ...
            if (type == String.class) {
                ...
                component = new ComboBox<T>(displayName);
                nullRepresentation = getInstanceT();
            }
/*
            return FieldPropertyView.builder()
                    ...
                    .build();
*/
            return new FieldPropertyEditor(viewColumn.displayName()
                    , field.getName()
                    , field
                    , component
                    , nullRepresentation
